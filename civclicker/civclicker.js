...
new Unit({ id:"ecavalry", name:"cavalry",
    alignment:"enemy",
    combatType:"cavalry", 
    prereqs: undefined, // Can be purchased.
    efficiency: 0.08,
    place: "party",
...
function DevElijahrules(){
    ...
    civData.barn.owned += 500000000000;
    civData.woodstock.owned += 500000000000;
    civData.stonestock.owned += 50000000000000;
    civData.herbs.owned += 10000000000;
    civData.skins.owned += 10000000000;
    civData.ore.owned += 10000000000;
    civData.leather.owned += 100000000000;
    civData.metal.owned += 10000000000;
    civData.piety.owned += 10000000000;
    civData.gold.owned += 10000000000;
    renameRuler("Cheater");
    updatePopulation();
    updateUpgrades();
    updateResourceTotals();
